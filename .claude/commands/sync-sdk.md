...
3. Verify the sync by running `diff -rq sdk/ worker/src/sdk/` and `diff -rq sdk/ dashboard/lib/sdk/`. Report any differences.
4. Stage the synced files with `git add worker/src/sdk/ dashboard/lib/sdk/ sdk/`.
